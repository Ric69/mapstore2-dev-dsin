...
class MeasureComponent extends React.Component {
    ...
    static defaultProps = {
        ...
        uomLengthValues: [{ value: 'm', label: 'm' }, { value: 'km', label: 'km' }],
        uomAreaValues: [
            { value: 'sqm', label: 'm²' },
            { value: 'sqkm', label: 'km²' },
            {
                    ...
                    <Row>
                        <FormGroup>
                            <Col xs={6}>
                                ...
                                <span id="measure-len-res">
                                    <NumberFormat
                                        key="len"
                                        numberParams={decimalFormat}
                                        value={this.props.formatLength(this.props.uom.length.unit, this.props.measurement.len)}
                                    />{' '}
                    ...
                    <Row>
                        <FormGroup>
                            <Col xs={6}>
                                ...
                                <span id="measure-area-res">
                                    <NumberFormat
                                        key="area"
                                        numberParams={decimalFormat}
                                        value={this.props.formatArea(this.props.uom.area.unit, this.props.measurement.area)}
                                    />{' '}
                        ...
                        <FormGroup>
                            <Col xs={12}>
                                {this.props.withReset ? (
                                    <ButtonGroup>
                                        <Button onClick={this.onResetClick}>{this.props.resetButtonText}</Button>
                                    </ButtonGroup>
                                ) : (
                                    <span />
                                )}
