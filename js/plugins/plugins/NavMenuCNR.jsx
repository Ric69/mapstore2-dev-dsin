...
// import src from '../images/cnr_logo_encapsule _RVB.png';
...
class NavMenu extends React.Component {
    ...
    renderIconedItem = (item, idx) => {
        return item.iconComponent ? item.iconComponent : (<NavItemT
            ...
            href="https://cnr.tm.fr/"
            onClick={isString(item.linkId) ? () => scrollIntoViewId(trimStart(item.linkId, '#')) : () => { }}>
            {item.glyph && <Glyphicon glyph={item.glyph} /> || <img className="customer-logo" src={src} height="30"/>}
        </NavItemT>);
    };
