...
class AZoomComponent extends React.Component {
    ...
    render() {
        ...
        return <div style={style}>
                ...
                <br/><br/>
                 <button className="btn btn-info" onClick={() => this.props.toZoomPt(this.props.pos,this.props.zoom, this.props.crs)}>Zoom To</button>
                <br/><br/>
                </div>;
    }
}
...
const AZoomSample = connect((state) => {
    return {
        ...
        toZoomPt:zoomToPoint// connected action
    })(AZoomComponent);

export const AZoomSamplePlugin = AZoomSample;
