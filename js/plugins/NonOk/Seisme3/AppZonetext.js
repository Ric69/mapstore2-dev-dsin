...
// import Zonetextz1 from './Zonetext/Zonetextz1';
// import Zonetextz2 from './Zonetext/Zonetextz2';
// var rayon1 = Math.pow(10, (0.58 + (0.25 * magnitude)));
// var txtz1 = Math.round(rayon1 * 10000) / 10000;
// var Z1 = ((Math.pow(10, (0.58 + (0.25 * magnitude)))) * 1000);
// var R1 = (Math.round(Z1 * 10000) / 10000);
// var R1 = (Math.round(((Math.pow(10, (0.58 + (0.25 * magnitude)))) * 1000) * 10000) / 10000);
// var rayon2 = Math.pow(10, (-0.02 + (0.25 * magnitude)));
// var txtz2 = Math.round(rayon2 * 10000) / 10000;
// var Z2 = ((Math.pow(10, (-0.02 + (0.25 * magnitude)))) * 1000);
// var R2 = Math.round(Z2 * 10000) / 10000;
// var R2 = (Math.round(((Math.pow(10, (-0.02 + (0.25 * magnitude)))) * 1000) * 10000) / 10000);
// import MyVector from "./MyLayer/MyLayer.tsx";
    ...
    render() {
        ...
        return ( 
            <div className = "AppZonetext">
                ...
                <br />               
                <hr />
                <button className="btn btn-success" id="calseisme" onClick={(e) => this.onSubmit(e)}>
                    Calcul !
                </button>
                &nbsp;&nbsp;&nbsp;&nbsp;
                <button className="btn btn-info" id="listseisme" onClick={(e) => this.onSubmit2(e)}>
                    Liste Impact !
                </button>
                &nbsp;&nbsp;&nbsp;&nbsp;
                <button className="btn btn-info" id="listseisme" onClick={(e) => this.userAction()}>
                    Zoom !
                </button>
                <br />
            </div>
