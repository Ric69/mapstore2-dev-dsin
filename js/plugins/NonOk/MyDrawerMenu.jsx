...
const Section = require('./Mydrawer/Section');
...
})(require('./Mydrawer/Menu'));

require('./Mydrawer/drawer.css');
...
const MyDrawerMenuPlugin = connect((state) => ({
...
module.exports = {
    MyDrawerMenuPlugin: assign(MyDrawerMenuPlugin, {
